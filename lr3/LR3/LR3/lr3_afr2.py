...
w0 = 2 * np.pi * np.sqrt(f2 * f1)
Bw = 2 * np.pi * (f2 - f1)

butt_b, butt_a = sgl.lp2bp(*sgl.zpk2tf(*sgl.buttap(n)), w0, Bw)
cheb1_b, cheb1_a = sgl.lp2bp(*sgl.zpk2tf(*sgl.cheb1ap(n, Rp)), w0, Bw)
cheb2_b, cheb2_a = sgl.lp2bp(*sgl.zpk2tf(*sgl.cheb2ap(n, Rs)), w0, Bw)
ell_b, ell_a = sgl.lp2bp(*sgl.zpk2tf(*sgl.ellipap(n, Rp, Rs)), w0, Bw)
bess_b, bess_a = sgl.lp2bp(*sgl.zpk2tf(*sgl.besselap(n)), w0, Bw)
